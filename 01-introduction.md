...
* GPT-5.5などの言語モデル自体の理論

### 進め方

* プログラミングは、人に教わる時間よりも、自分で手を動かしながら試す時間のほうが長いものです。わからないことが出てきたら、まずはAIに聞いてみましょう。
* この資料のページURL（例：<https://codex.keioaic.dev/01-introduction.html>）や、今見ている画面のスクリーンショットをAIに送ると、状況に合わせて手順を噛み砕いて説明してくれます。AIは何度でも質問できる、講師より詳しい相棒です。
* 慶應生であれば、大学のアカウントで [Gemini](https://gemini.google.com/) も使えるはずです。ChatGPTやGeminiなど、使いやすいAIにどんどん質問してみてください。
* もちろん、それでも詰まることはあります。そのときはTAや講師を呼んでください。まずは自分で調べ、試し、それでも困ったら人に聞く、という進め方に慣れていきましょう。
* すでにGitやGitHubに慣れている人は、どんどん進めて構いません。周りの人が困っていたら助けてあげましょう

![AIに資料URLを渡して質問する例](./images/codex-ask.png)
...
* ターミナル上でGPT-5系モデルやCodex向けモデルを利用して、コード生成・修正や文章作成などを自然言語で操作できます。

### GPT-5系モデルとCodex CLIの違い

![GPT-5 Normal](./images/chatgpt.png)

*ブラウザーで使用するChatGPT（GPT-5系モデル）*

* **GPT-5系モデル**：OpenAIが開発している言語モデル群の総称。テキスト・画像などを扱える基盤モデルで、ChatGPT、Codex、アプリ、APIなどから呼び出されます。モデル名は更新され続けており、現在は `gpt-5.5` のような新しいモデルも使われています。
