...
* 今日作るWebサイトはインターネット上に公開されます。本名、住所、電話番号、メールアドレス、学校名、顔写真、制服が写った写真など、個人が特定される情報は載せないでください。公開してよいニックネームや、好きなもの・作品の紹介などにしましょう。
* 操作で詰まったときや、画面が資料と違って見えるときは、TAや講師を呼んでください。わからないまま進めず、早めに確認しましょう。
